...
def run():
    ...
    st.markdown('''<h1 style='text-align: center; margin-bottom: 2rem;'>AI Resume Analyzer</h1>''', unsafe_allow_html=True)
    st.sidebar.markdown("# Choose Something...")
    activities = ["User", "Feedback", "About", "Admin"]
    choice = st.sidebar.selectbox("Choose among the given options:", activities)
    link = '<b><a href="#" style="text-decoration: none; color: #021659;">AI Assistant</a></b>' 
    ...
    # Create the DB (sqlite creates file if not exists)
    ...
    if choice == 'User':
        ...
        dev_user = os.environ.get('USERNAME', os.environ.get('USER', 'Cloud User'))
